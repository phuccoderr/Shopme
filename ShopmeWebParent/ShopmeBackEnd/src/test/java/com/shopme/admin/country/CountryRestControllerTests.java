...
public class CountryRestControllerTests {
    ...
    @Autowired ObjectMapper objectMapper; //chuyen du lieu json thanh java

    @Autowired CountryRepository repo;

    //day chi 1 user fake , cho user hay password nao cung duoc
    @Test
    @WithMockUser(username = "thi29@gmail.com",password = "something",roles = "ADMIN")
    public void testListCountries() throws Exception {
        String url = "/countries/list";
        MvcResult result = mockMvc.perform(get(url))
                .andExpect(status().isOk()) //ma trang thai du kien 200
                .andDo(print()) //Dòng này in chi tiết yêu cầu và phản hồi tới bảng điều khiển nhằm mục đích gỡ lỗi.
                .andReturn();
